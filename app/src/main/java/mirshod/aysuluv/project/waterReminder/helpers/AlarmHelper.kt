...
import mirshod.aysuluv.project.waterReminder.recievers.BootReceiver
import mirshod.aysuluv.project.waterReminder.recievers.NotifierReceiver
import java.util.concurrent.TimeUnit

class AlarmHelper {
    private var alarmManager: AlarmManager? = null

    private val ACTION_BD_NOTIFICATION = "Drink-Water-Alert"
